...
const plans = [
  {
    name: t("pricing.free_name"), price: t("pricing.free_price"), period: t("pricing.month"),
  ...
  {
    name: t("pricing.premium_name"), price: t("pricing.premium_price"), period: t("pricing.month"),
